...
<template>
  <aside class="fixed top-0 left-0 h-screen w-56 bg-[#16161a] border-r border-[#2d2d38] flex flex-col z-50">
    <!-- Logo -->
    <div class="p-5 border-b border-[#2d2d38]">
      <div class="flex items-center gap-2">
        <div class="w-8 h-8 rounded bg-[#c10b21] flex items-center justify-center text-white font-bold text-sm">G</div>
        <div>
