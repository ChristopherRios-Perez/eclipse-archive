...
// Berserk apostle data
const apostles = [
  {
    id: 1, name: 'Zodd the Immortal', arc: 'Golden Age',
    status: 'Alive', title: 'God Hand Servant',
    firstAppearance: 'Volume 1, Chapter 2',
    description: 'An immortal warrior apostle who has fought for centuries. One of the most powerful apostles and later becomes a servant of Griffith.',
    img: 'https://upload.wikimedia.org/wikipedia/en/thumb/4/42/Nosferatu_Zodd_Design.png/220px-Nosferatu_Zodd_Design.png',
  },
  {
    id: 2, name: 'The Count', arc: 'Golden Age',
    status: 'Deceased', title: 'Apostle Lord',
    firstAppearance: 'Volume 1, Chapter 1',
    description: 'The first major apostle encountered by Guts. A corpulent nobleman who sacrificed his wife to become an apostle.',
    img: null,
  },
  {
    id: 3, name: 'Wyald', arc: 'Golden Age',
    status: 'Deceased', title: 'Black Dog Knight',
    firstAppearance: 'Volume 10',
    description: 'A massive, brutal apostle who led the Black Dog Knights. Known for extraordinary cruelty and power.',
    img: null,
  },
  {
    id: 4, name: 'Rosine', arc: 'Conviction',
    status: 'Deceased', title: 'Elf Queen',
    firstAppearance: 'Volume 16',
    description: 'A young girl who became an apostle and created a false paradise for children. One of the more tragic apostles in the series.',
    img: null,
  },
  {
    id: 5, name: 'The Egg of the Perfect World', arc: 'Conviction',
    status: 'Transcended', title: 'Apostle',
    firstAppearance: 'Volume 22',
    description: 'A deformed creature who swallowed the Crimson Beherit, allowing Griffith to reincarnate into the physical world.',
    img: null,
  },
  {
    id: 6, name: 'Mozgus', arc: 'Conviction',
    status: 'Deceased', title: 'Holy Inquisitor',
    firstAppearance: 'Volume 18',
    description: 'A fanatical inquisitor who became an angel-like apostle. Serves as the primary antagonist of the Conviction arc.',
    img: null,
  },
  {
    id: 7, name: 'Grunbeld', arc: 'Millennium Falcon',
    status: 'Alive', title: 'Great Apostle',
    firstAppearance: 'Volume 27',
    description: 'A massive knight apostle who serves as one of Griffith\'s most powerful commanders in the reborn Band of the Hawk.',
    img: null,
  },
  {
    id: 8, name: 'Ganishka', arc: 'Fantasia',
    status: 'Transcended', title: 'Emperor',
    firstAppearance: 'Volume 30',
    description: 'The most powerful apostle in the series, the Emperor of Kushan who transforms into a colossal fog giant.',
    img: null,
  },
  {
    id: 9, name: 'Locus', arc: 'Millennium Falcon',
    status: 'Alive', title: 'Moonlight Knight',
    firstAppearance: 'Volume 28',
    description: 'A chivalric apostle who serves Griffith. Known as the Moonlight Knight for his lance mastery.',
    img: null,
  },
  {
    id: 10, name: 'Irvine', arc: 'Millennium Falcon',
    status: 'Alive', title: 'Archer Apostle',
    firstAppearance: 'Volume 28',
    description: 'A wolf-like apostle with extraordinary archery skills. One of the five falcon-wing generals under Griffith.',
    img: null,
  },
  {
    id: 11, name: 'The Baron', arc: 'Black Swordsman',
    status: 'Deceased', title: 'Snake Baron',
    firstAppearance: 'Volume 1',
    description: 'One of the earliest apostles faced by Guts in his journey of revenge. Ruler of a small domain with a snake-like apostle form.',
    img: null,
  },
  {
    id: 12, name: 'Female Apostle', arc: 'Golden Age',
    status: 'Deceased', title: 'Unnamed Apostle',
    firstAppearance: 'Volume 3',
    description: 'A female apostle encountered during Guts\'s early travels. One of the first to recognise the mark of sacrifice on Guts.',
    img: null,
  },
]
  ...
  <div class="p-6 min-h-screen bg-[#111114]">
    ...
    <div class="grid grid-cols-4 gap-4">
      ...
      >
        ...
        <!-- Info -->
        <div class="p-4">
          <h3 class="text-white font-semibold mb-0.5 group-hover:text-[#c10b21] transition-colors">{{ apostle.name }}</h3>
          <p class="text-[#5a5a72] text-xs mb-2">{{ apostle.title }}</p>
          <div class="flex items-center justify-between text-xs text-[#5a5a72]">
            <span>First Appearance</span>
            <span class="text-[#8888a0]">{{ apostle.arc }}</span>
          </div>
          <p class="text-[#8888a0] text-xs mt-0.5 truncate">{{ apostle.firstAppearance }}</p>
        </div>
      </div>
    </div>
