      ...
      <div class="flex gap-8">
        ...
        <div class="shrink-0 w-56">
          <div class="w-56 h-72 bg-[#16161a] rounded-xl border border-[#2d2d38] overflow-hidden">
            <img v-if="getCover(apostle.coverVolume)" :src="getCover(apostle.coverVolume)" :alt="apostle.name" class="w-full h-full object-cover object-top" referrerpolicy="no-referrer" />
