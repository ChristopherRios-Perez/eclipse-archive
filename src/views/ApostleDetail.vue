...
const apostles = [
  ...
  { id: 13, coverVolume: 30, name: 'Rakshas',                       arc: 'Fantasia',          status: 'Alive',       title: 'Shadow Apostle',      firstAppearance: 'Volume 29', description: 'A mysterious and unsettling apostle serving in Griffith\'s reborn Band of the Falcon. His apostle form is a shapeshifting mass of shadowy tendrils and cloth-like darkness that can slice through almost anything. Despite serving Griffith outwardly, Rakshas secretly covets Griffith\'s face and harbours a personal obsession with removing it. He is one of the most enigmatic members of the Falcon.',  abilities: ['Shapeshifting shadow form', 'Razor tendrils', 'Near-perfect stealth', 'Extreme agility'] },
  { id: 14, coverVolume: 35, name: 'The Sea God',                   arc: 'Fantasia',          status: 'Deceased',    title: 'Ancient Leviathan',   firstAppearance: 'Volume 34', description: 'An ancient and colossal apostle who slumbered beneath the sea for centuries, worshipped as a god by a remote island village that offered human sacrifices to it. Guts and his companions are forced to battle it from within during their voyage to Skellig. Widely regarded as one of the largest and oldest apostles ever encountered in the series.',                                                   abilities: ['Colossal sea creature form', 'Regeneration', 'Entire ecosystem lives within its body', 'Tentacle control'] },
  { id: 15, coverVolume: 4,  name: 'Bonebeard',                     arc: 'Black Swordsman',   status: 'Deceased',    title: 'Pirate Apostle',      firstAppearance: 'Volume 3',  description: 'A ruthless pirate captain who used a Beherit to become an apostle and terrorised coastal villages. Encountered by Guts during his early Black Swordsman wanderings. His defeat comes swiftly at the hands of Guts, demonstrating the gap in power between ordinary apostles and the Black Swordsman.',                                                                                          abilities: ['Apostle transformation', 'Enhanced physical power', 'Commands pirate fleet'] },
  { id: 16, coverVolume: 2,  name: 'The Slug Baron',                arc: 'Black Swordsman',   status: 'Deceased',    title: 'Apostle Lord',        firstAppearance: 'Volume 1',  description: 'A grotesque slug-like apostle who lorded over a domain of miserable subjects in the early Black Swordsman arc. His defeat at Guts\'s hands provides a key lead on the whereabouts of a Beherit. One of the first apostles to reveal just how widespread the God Hand\'s influence truly is.',                                                                                                 abilities: ['Slug apostle form', 'Acid secretion', 'Immense bulk and durability'] },
]
